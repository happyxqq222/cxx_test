...
class ByteBuffer : public muduo::copyable
{
 public:
  ...
  void markReaderIndex() {
    markedReaderIndex_ = readerIndex_;
    isReaderMarked = true;
  }

  void markWriterIndex() {
    markedWriterIndex_ = writerIndex_;
    isWriterMarked = true;
  }

  void resetReaderIndex() {
    if(isReaderMarked) {
      this->readerIndex_ = markedReaderIndex_;
      isReaderMarked = false;
    }
  }

  void resetWriterIndex() {
    if(isWriterMarked) {
      this->writerIndex_ = markedWriterIndex_;
      isWriterMarked = false;
    }
  }
 ...
 private:
  ...
  size_t readerIndex_;
  size_t writerIndex_;
  size_t markedReaderIndex_;
  size_t markedWriterIndex_;
  bool isReaderMarked = false;
  bool isWriterMarked = false;
