...
#ifndef MQTTSERVER_MQTTCOMMON_H
#define MQTTSERVER_MQTTCOMMON_H
...
enum class MQTT_ACL_TYPE : uint8_t { USERNAME, IPADDR, CLIENTID };

enum class MQTT_ACL_MODE : uint8_t { EQ, RE };

enum class MQTT_ACL_ACTION : uint8_t { SUB, PUB, ALL };
